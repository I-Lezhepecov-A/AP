...
cur.execute('''CREATE TABLE countries
               (name text, iso_code text, population int, total_vaccinated int, percentage_vaccinated real)''')  # noqa
cur.execute('''INSERT INTO countries
               ...
               ('Central Europe and the Baltics','OWID_CEB','102253057','500000','0.48898293573 ')''')  # noqa
